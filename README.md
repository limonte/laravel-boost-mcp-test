## This is a repro repo for issue https://github.com/laravel/boost/issues/372

In repo Settings -> Copilot -> Coding Agent this is set for custom MCP servers:
...
And this is the resulting error when trying to use Copilot Coding Agent:
